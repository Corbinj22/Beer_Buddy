  ...
  return (
    <section className="expandedBeer-container">
      <div className="top-card-container">
        ...
        <div className="all-details">
          ...
          <div className="details-container">
            ...
            <p className="beer-detail">Tagline: {matchedBeer.tagline}</p>
            <p className="beer-detail">
              Average Raiting: {matchedBeer.average} stars
            </p>
            <p className="beer-detail">Please Leave A Raiting:</p>
            <form>
              <button
                className="user-rate-btn"
                onClick={submitAverage}
                type="click"
              >
                Submit
              </button>
      ...
      <div className="bottom-card-container">
        <p className="desciption-text card-text">
          <span className="description-rule">Desciption</span>
